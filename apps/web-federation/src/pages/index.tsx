import { useQuery, withWunderGraph } from "generated-federation";
  ...
  return (
	...
	c0-30.5,5.8-59.7,16.7-86.5L484.4,669l69-116.7l68.5,116.5l83.8-142.5H785C772,642.8,673.3,733.2,553.4,733.2z"
        ...
        <p className="mx-auto mt-6 max-w-3xl text-center text-lg text-slate-600 dark:text-slate-400">
          ...
          to combine multiple GraphQL APIs into a single GraphQL API through the
          Apollo Federation specification.
        </p>
      </div>
      <div className="relative flex flex-col items-center overflow-hidden p-8 sm:p-12">
        <div className="max-w-1/2 w-full rounded-2xl bg-blue-50 px-20 py-14">
          <div className="mx-auto flex max-w-sm flex-col items-center">
            <p className="mb-8 mt-3 text-center text-black/80">
              This is the result of your{" "}
              <code className="font-mono font-medium text-amber-500">
                TopProducts
              </code>{" "}
              operation. This operation calls internally the Product, Accounts
              Inventory and Review service.
            </p>
